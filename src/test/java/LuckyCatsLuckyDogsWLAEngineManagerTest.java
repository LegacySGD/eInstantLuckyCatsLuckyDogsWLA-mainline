...
//@Ignore
public class LuckyCatsLuckyDogsWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(LuckyCatsLuckyDogsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LuckyCatsLuckyDogsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LuckyCatsLuckyDogsWLAIW/InitOutcome.xml").getDocumentElement();
